/**
 * @file Medical.c
 * @author Devangi (you@domain.com)
 * @brief This a Medical Store Management System
 * @version 0.1
 * @date 2021-07-06
 * 
...
void box()
{
   for(i=3;i<=79;i++) 	//This 'FOR' loop will print a combination of
	...
	{                       //vertically till the 3rd row is reached.
		gotoxy(3,i);
		printf("%c",219);
		gotoxy(79,i);
		printf("%c",219);
...
//   window(1,1,80,50);
	...
	gotoxy(10,8);
	printf("=> The project is about Medical Store Management System ");
	gotoxy(10,10);
	printf("=> In this project we Can Add Medicine,Customer and Supplier Details");
	gotoxy(10,12);
	printf("=> We can update and Delete Existing Record");
	gotoxy(10,14);
	printf("=> We can also search Medicine,Customer and Supplier Details");
	gotoxy(10,16);
	printf("=> It will be helpful to display & maintain all records using a single system");
